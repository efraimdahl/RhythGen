...
For converting **ABC notation** files from / to **MusicXML** files, please view [data/README.md](https://github.com/efraimdahl/RhythGen/blob/main/data/README.md) for instructions.
...
### ⚙️ [Evaluation](https://github.com/sanderwood/clamp2) Setup
