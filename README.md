...
## 📚 Data
In the `public_data` folder you can find a collection of music generated by different model configurations described in [public_data/README.md](https://github.com/efraimdahl/RhythGen/blob/main/data/README.md) and in my [Masters Thesis](). 
