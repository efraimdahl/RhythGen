...
"""
The majority of this code is adapted from ABCToolkit https://pypi.org/project/abctoolkit/
"""
...
def check_alignment_according_to_barline_and_bartext_dict(left_barline_dict, bar_text_dict, right_barline_dict):
    ...
    return barline_equal_flag, bar_no_equal_flag, bar_dur_equal_flag, len(bar_text_dict["V:1"])
...
def remove_bar_no_annotations_rotated(abc_lines: list):
    # 去掉行末的小节号
    metadata_lines, tunebody_lines = extract_metadata_and_tunebody_rotated(abc_lines)
